  ...
  return( 
    <>
     <div className='flex items-center justify-between py-5 font-medium'>
        <h1 className='unlock-regular font-extrabold text-2xl '>LEATHERZ</h1>
       <ul className='hidden sm:flex gap-5 text-sm text-grey-700'>
        ...
        <NavLink className='flex flex-col items-center gap-1' to='/limited'>
          <p>LIMITED DEALS</p>
          <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden'/>
        </NavLink>
       ...
       <div className='flex items-center gap-6'>
        <img onClick={()=>setShowSearch(true)} src={assets.search_icon} className='cursor-pointer w-5' alt="search-icon" />
