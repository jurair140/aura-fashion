...
export const products = [
    ...
    {
        _id: "aaaac",
        name: "Kids' Stylish Leather Shoes",
        description: "Soft and durable leather shoes for kids, offering a snug fit and non-slip soles for safe and stylish steps.",
        price: 1799,
        image: [p_img3],
        category: "Kids",
        subCategory: "Footwear",
    ...
    {
        _id: "aaaad",
        name: "Men’s Rugged Leather Boots",
        description: "High-quality rugged leather boots designed for adventure, featuring a solid grip, ankle support, and waterproof finish.",
        price: 3899,
        image: [p_img4],
        category: "Men",
        subCategory: "Boots",
